...
class ConfigureMentions
{
    ...
    private function configureUserMentions(Configurator $config)
    {
        ...
        $tag->filterChain->prepend([static::class, 'addUserId'])
            ->setJS('function(tag) { return flarum.extensions["starinc-nex_mentions"].filterUserMentions(tag); }');
    ...
    private function configurePostMentions(Configurator $config)
    {
        ...
        $tag->filterChain
            ...
            ->setJS('function(tag) { return flarum.extensions["starinc-nex_mentions"].filterPostMentions(tag); }');
